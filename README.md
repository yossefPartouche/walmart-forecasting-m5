<table width="100%">
  <tr style="background-color: #e6f0fa;">
    <td style="padding: 24px; border: 1px solid #b3d1ff; border-radius: 12px;">
      <h1 align="center" style="margin: 0; color: #004d99; border-bottom: none;">🔆 M5 Walmart Hierarchical Forecasting</h1>
    </td>
  </tr>
</table>
